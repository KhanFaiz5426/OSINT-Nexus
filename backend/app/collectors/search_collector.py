...
def _get_search_config() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "max_results_per_provider": getattr(settings, "SEARCH_MAX_RESULTS_PER_PROVIDER", 10),
        }
    except Exception:
        return {
            "searxng_base_url": "",
...
class SearchCollector(OSINTCollector):
    ...
    async def _collect_username_searches(self, target: str, target_type: TargetType) -> RawResult:
